...
class Song(object):
    ...
    def __init__(self, song_data):
        # Check checksums
        assert song_data.mem_init_flag_1 == b'rb' #.decode('utf-8')
        assert song_data.mem_init_flag_2 == b'rb' #.decode('utf-8')
        assert song_data.mem_init_flag_3 == b'rb' #.decode('utf-8')
